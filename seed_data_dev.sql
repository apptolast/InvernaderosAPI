...
-- Datos Ficticios Super Realistas
-- =====================================================
...
(
    ...
    3200.00,
    'Naranjos (Citrus sinensis - Navelina)',
    'Europe/Madrid',
    TRUE,
...
-- =====================================================
-- VERIFICATION - PostgreSQL Metadata
-- =====================================================

-- Count records by table
SELECT 'tenants' as table_name, COUNT(*) as count FROM metadata.tenants
UNION ALL
