...
data class TenantResponse(
    ...
    @Schema(description = "Dirección física o ubicación") val address: String?,
...
data class TenantCreateRequest(
    ...
    @Schema(description = "Ubicación/Dirección", example = "Calle Mayor 123")
...
data class TenantUpdateRequest(
    ...
    @Schema(description = "Ubicación/Dirección")
    val address: String? = null,
