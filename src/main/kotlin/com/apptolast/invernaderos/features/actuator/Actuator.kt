...
/**
 * Entity que representa un Actuador (dispositivo de control) en un invernadero. Los actuadores
 * controlan elementos físicos: ventiladores, riego, calefacción, etc.
 *
...
@Table(
        ...
        indexes =
                [
                        ...
                        Index(
                                name = "idx_actuators_greenhouse_active",
        ...
        uniqueConstraints =
                [
                        UniqueConstraint(
                                name = "uq_actuator_code_per_greenhouse",
                                columnNames = ["greenhouse_id", "actuator_code"]
                        ),
                        UniqueConstraint(
                                name = "uq_actuator_device_id_per_greenhouse",
                                columnNames = ["greenhouse_id", "device_id"]
                        )]
)
data class Actuator(
        ...
        /**
         * Código corto único del actuador dentro del greenhouse. Ejemplo: "FAN01", "RIEGO02",
         * "CALEF01"
         */
        @Column(name = "actuator_code", nullable = false, length = 50) val actuatorCode: String,
        @Column(name = "device_id", nullable = false, length = 50) val deviceId: String,

        /**
         * Tipo de actuador. Valores posibles: VENTILADOR, FAN, RIEGO, IRRIGATION, CALEFACCION,
         * HEATING, ENFRIAMIENTO, COOLING, ILUMINACION, LIGHTING, CORTINA, CURTAIN, VALVULA, VALVE,
         * MOTOR, EXTRACTOR, OTHER
         */
        @Column(name = "actuator_type", nullable = false, length = 50) val actuatorType: String,

        /**
         * ID del tipo de actuador normalizado (SMALLINT). References: metadata.actuator_types.id
