...
import com.apptolast.invernaderos.entities.metadata.entity.Actuator
...
/**
 * Repository para operaciones CRUD de Actuators.
...
interface ActuatorRepository : JpaRepository<Actuator, UUID> {
    ...
    /**
     * Query personalizado: Actuadores con última actualización antigua (desconectados).
     * Útil para detectar actuadores que no han reportado estado recientemente.
     */
    @Query(
        """
